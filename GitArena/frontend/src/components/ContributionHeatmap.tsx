...
const ContributionHeatmap: React.FC<ContributionHeatmapProps> = ({ data }) => {
    ...
    const getLevelColor = (level: number) => {
        const colors = {
            ...
            1: 'bg-cyan-900/40 border-cyan-700/40',
            2: 'bg-cyan-700/60 border-cyan-600/60',
            3: 'bg-cyan-500/80 border-cyan-400/80',
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-4 text-sm">
                    <div className="text-center px-4 py-2 bg-gray-900/50 rounded-lg border border-gray-700">
                        <div className="text-2xl font-bold text-cyan-400">{totalContributions}</div>
                                    ...
                                    {[0, 1, 2, 3, 4, 5, 6].map(dayIndex => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                style={{ animation: `fadeInScale 0.3s ease-out ${(weekIndex * 7 + dayIndex) * 0.002}s both` }}
                                            >
                                                {/* Tooltip */}
                                                <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block z-50">
                                                    <div className="bg-gray-900 text-white text-xs px-3 py-2 rounded-lg whitespace-nowrap shadow-xl border border-gray-700">
                                                        ...
                                                        <div className="text-gray-400">{new Date(day.date).toLocaleDateString('en-US', { weekday: 'short', month: 'short', day: 'numeric' })}</div>
